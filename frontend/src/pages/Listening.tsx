...
const Listening = () => {
	...
	const [selectedAnswers, setSelectedAnswers] = useState(Array(listening.test.length).fill(null));
					...
					<div className="max-w-[1230px] text-smrtBlack mx-auto border-[1px] pt-[45px] pb-[68px] px-[95px] rounded-[30px] box-shadow-5px">
						...
						<div className="flex flex-wrap gap-[30px] text-[20px] justify-between font-medium">
							{listening.test.map((question) => (
								<>
									<div className="w-[435px] mb-[70px]" key={question.id}>
										<div className="flex items-baseline gap-[8px]">
											<h4>{question.id + 1}.</h4>
											<h4 className="leading-[120%] pb-[8px]">{question.question}</h4>
										</div>
